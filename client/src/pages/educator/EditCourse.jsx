...
const EditCourse = ({ course, onClose, onSave }) => {
  ...
  const [chapters, setChapters] = useState(course.courseContent || []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${backendUrl}/api/educator/edit-course/${course._id}`,
        formData,
  ...
  return (
    <div className='overflow-scroll flex flex-col items-start justify-between p-2'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor='thumbnailImage' className='flex items-center gap-3'>
              ...
              <img className='max-h-10' src={image ? URL.createObjectURL(image) : course.courseThumbnail} alt="" />
            </label>
          </div>
        </div>
        <div className='flex flex-col gap-1'>
