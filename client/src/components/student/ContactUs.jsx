...
const ContactUs = () => {
  return (
    <div className="w-full flex flex-col md:flex-row justify-center items-start gap-12 px-8 md:px-24 py-16 bg-white">
      {/* Left: Contact Form */}
      <div className="flex-1 max-w-lg bg-white rounded-lg shadow-lg p-8 flex flex-col items-center">
      ...
      {/* Right: Contact Info */}
      <div className="flex-1 max-w-xl bg-white rounded-lg shadow-lg p-8 flex flex-col justify-between">
