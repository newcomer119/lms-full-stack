  ...
  return (
    <div className="py-16 md:px-40 px-8">
      ...
      <p className="md:text-base text-sm text-gray-500 mt-3">
         Discover our top-rated courses for Class 9, 10, 11, and 12 (CBSE), as well as premier preparation for JEE Main, JEE Advanced, NDA, and other competitive exams. Our expertly designed programs are crafted to help you achieve academic excellence and exam success.
      </p>
